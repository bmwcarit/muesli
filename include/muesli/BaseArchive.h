...
private:
    ...
    auto dispatch(T&& arg) -> decltype(arg.load(static_cast<D*>(this)->self), EnableIfXArchive<tag::InputArchive, C>())
    {
        arg.load(self);
    }
    ...
    template <typename T, typename D = Derived, typename C = Category>
    auto dispatch(T&& arg) -> decltype(load(static_cast<D*>(this)->self, arg), EnableIfXArchive<tag::InputArchive, C>())
    {
        load(self, arg);
    }
    ...
    template <typename T, typename D = Derived, typename C = Category>
    auto dispatch(T&& arg) -> decltype(arg.save(static_cast<D*>(this)->self), EnableIfXArchive<tag::OutputArchive, C>())
    {
        arg.save(self);
    }
    ...
    template <typename T, typename D = Derived, typename C = Category>
    auto dispatch(T&& arg) -> decltype(save(static_cast<D*>(this)->self, arg), EnableIfXArchive<tag::OutputArchive, C>())
    {
        save(self, arg);
    }
